...
app.get('/', (req, res) => {
    res.sendFile(path.join(__dirname, 'Thanh-Toan-Hoc-Phi.html'));
});
...
app.post('/mock-api/GetData', (req, res) => {
    ...
    const sampleData = {
        ...
        "data": {
            ...
            "Payment": [
                {
                    "stt_rec": req.body.stt_rec || "A000312452HD8",
...
app.listen(PORT, () => {
    ...
    console.log(`Để xem trang thanh toán học phí, truy cập: http://localhost:${PORT}?stt_rec=A000312452HD8`);
});